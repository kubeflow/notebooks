...
const setupWorkspaceWithResources = (
  ...
  resourcesResponse?: { error: { code: string; message: string } },
) => {
...
describe('Workspace Resources Tab', () => {
  ...
  it('should show a generic error when resource usage fails to load', () => {
    setupWorkspaceWithResources(undefined, V1Beta1WorkspaceState.WorkspaceStateRunning, {
