          ...
          <Thead>
            <Tr>
              ...
              {visibleColumnKeys.includes('name') && (
                <Th
                  width={wsTableColumns.name.width}
              ...
              {visibleColumnKeys.includes('image') && (
                <Th
                  width={wsTableColumns.image.width}
              ...
              {visibleColumnKeys.includes('kind') && (
                <Th
                  width={wsTableColumns.kind.width}
              ...
              {visibleColumnKeys.includes('namespace') && (
                <Th
                  width={wsTableColumns.namespace.width}
              ...
              {visibleColumnKeys.includes('state') && (
                <Th
                  width={wsTableColumns.state.width}
              ...
              {visibleColumnKeys.includes('gpu') && (
                <Th
                  width={wsTableColumns.gpu.width}
              ...
              {visibleColumnKeys.includes('idleGpu') && (
                <Th
                  width={wsTableColumns.idleGpu.width}
              ...
              {visibleColumnKeys.includes('lastActivity') && (
                <Th
                  width={wsTableColumns.lastActivity.width}
              ...
              {visibleColumnKeys.includes('connect') && (
                <Th width={wsTableColumns.connect.width} screenReaderText="Connect action" />
              )}
              {visibleColumnKeys.includes('actions') && (
                <Th width={wsTableColumns.actions.width} screenReaderText="Primary action" />
              )}
            </Tr>
          </Thead>
