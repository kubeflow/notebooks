...
export const Workspaces: React.FunctionComponent = () => {
    ...
    >
      <MenuContent>
        <MenuList>
          ...
          <MenuItem itemId="CPU">CPU</MenuItem>
          <MenuItem itemId="RAM">RAM</MenuItem>
  ...
  const onFilter = (workspace: Workspace) => {
    ...
    return (
      ...
      (activeAttributeMenu === 'CPU' &&
          workspace.CPU.search(searchValueInput) >= 0) ||
      (activeAttributeMenu === 'RAM' &&
          workspace.RAM.search(searchValueInput) >= 0)
    );
  };
