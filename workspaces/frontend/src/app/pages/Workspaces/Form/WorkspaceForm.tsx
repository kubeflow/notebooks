...
const WorkspaceForm: React.FC = () => {
  ...
  }, [api, data, mode, namespace, navigate, notification]);
                  ...
                  <Flex direction={{ default: 'column' }} rowGap={{ default: 'rowGapXl' }}>
                    {submitError && (
                      <FlexItem>
                        <Alert
                          variant="danger"
                          title={`Failed to ${mode === 'create' ? 'create' : 'update'} workspace`}
                          actionClose={
                            <AlertActionCloseButton onClose={() => setSubmitError(null)} />
                          }
