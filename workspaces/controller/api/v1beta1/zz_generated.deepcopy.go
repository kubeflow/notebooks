...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkspaceActivityStatus) DeepCopyInto(out *WorkspaceActivityStatus) {
	*out = *in
	out.LastProbe = in.LastProbe
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkspaceActivityStatus.
func (in *WorkspaceActivityStatus) DeepCopy() *WorkspaceActivityStatus {
	if in == nil {
		return nil
	}
	out := new(WorkspaceActivityStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkspaceKindCullingConfig) DeepCopyInto(out *WorkspaceKindCullingConfig) {
	*out = *in
	...
	if in.MaxProbeIntervalSeconds != nil {
		in, out := &in.MaxProbeIntervalSeconds, &out.MaxProbeIntervalSeconds
		*out = new(int32)
		**out = **in
	}
