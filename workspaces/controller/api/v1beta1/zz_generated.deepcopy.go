...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ErrorList) DeepCopyInto(out *ErrorList) {
	{
		in := &in
		*out = make(ErrorList, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ErrorList.
func (in ErrorList) DeepCopy() ErrorList {
	if in == nil {
		return nil
	}
	out := new(ErrorList)
