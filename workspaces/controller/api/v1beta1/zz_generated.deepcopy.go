...
func (in *ImageAssetStatus) DeepCopyInto(out *ImageAssetStatus) {
	*out = *in
	if in.ConfigMap != nil {
		...
		*out = new(WorkspaceKindConfigMapStatus)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkspaceKindConfigMapStatus) DeepCopyInto(out *WorkspaceKindConfigMapStatus) {
	*out = *in
	if in.Error != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkspaceKindConfigMapStatus.
func (in *WorkspaceKindConfigMapStatus) DeepCopy() *WorkspaceKindConfigMapStatus {
	if in == nil {
		return nil
	}
	out := new(WorkspaceKindConfigMapStatus)
