...
var _ = BeforeSuite(func() {
	...
	a, err = NewApp(&config.EnvConfig{UserIdHeader: userIdHeader, GroupsHeader: groupsHeader}, appLogger, k8sClient, imageSourceConfigMapClient, k8sManager.GetScheme(), reqAuthN, reqAuthZ, clientset)
	Expect(err).NotTo(HaveOccurred())
